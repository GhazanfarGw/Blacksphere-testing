  ...
  return (
    ...
    >
      <div className="mx-auto max-w-screen-xl px-4 md:px-10 flex items-center justify-between">
        ...
        {/* Desktop Menu */}
        <nav className="hidden md:flex space-x-6 text-sm tracking-wide items-center">
          ...
          <Link to="/online-payments" className="hover:text-[#1A2B6B] hover:font-semibold duration-500 hover:text-base hover:border-b-2 border-[#1A2B6B] font-bold">Online Payments</Link>
          <Link to="/payroll" className="hover:text-[#1A2B6B] hover:font-semibold duration-500 hover:text-base hover:border-b-2 border-[#1A2B6B] font-bold">Crypto Payroll</Link>
          <Link to="/billing" className="hover:text-[#1A2B6B] hover:font-semibold duration-500 hover:text-base hover:border-b-2 border-[#1A2B6B] font-bold">Billing</Link>
          <Link to="/retail" className="hover:text-[#1A2B6B] hover:font-semibold duration-500 hover:text-base hover:border-b-2 border-[#1A2B6B] font-bold">Retail</Link>
          <Link to="/online-consulting" className="hover:text-[#1A2B6B] hover:font-semibold duration-500 hover:text-base hover:border-b-2 border-[#1A2B6B] font-bold">Online Consulting</Link>
              ...
              <div className="absolute left-0 duration-300 w-[700px] bg-white shadow-lg p-6 grid grid-cols-2 gap-6 border rounded-md">
                <div>
                  <ul className="space-y-4 text-sm">
                    <li><Link to="/online-payments" className="hover:text-[#1A2B6B] hover:font-semibold duration-500 hover:text-base hover:border-b-2 border-[#1A2B6B] font-bold">Liquidity Management</Link></li>
                    <li><Link to="/billing" className="hover:text-[#1A2B6B] hover:font-semibold duration-500 hover:text-base hover:border-b-2 border-[#1A2B6B] font-bold">Security Risk</Link></li>
                    <li><Link to="/retail" className="hover:text-[#1A2B6B] hover:font-semibold duration-500 hover:text-base hover:border-b-2 border-[#1A2B6B] font-bold">Asset Protection</Link></li>
                  </ul>
                </div>
              </div>
            )}
