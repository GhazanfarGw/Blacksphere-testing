              ...
              <div className="absolute left-0 duration-300 w-[700px] bg-white shadow-lg p-6 grid grid-cols-2 gap-6 border rounded-md">
                <div>
                  <ul className="space-y-4 text-sm">
                    <li><Link to="/liquidity-management" className="hover:text-[#1A2B6B] hover:font-semibold duration-500 hover:text-base hover:border-b-2 border-[#1A2B6B] font-bold">Liquidity Management</Link></li>
                    <li><Link to="/security-risk" className="hover:text-[#1A2B6B] hover:font-semibold duration-500 hover:text-base hover:border-b-2 border-[#1A2B6B] font-bold">Security Risk</Link></li>
                    <li><Link to="/asset-protection" className="hover:text-[#1A2B6B] hover:font-semibold duration-500 hover:text-base hover:border-b-2 border-[#1A2B6B] font-bold">Asset Protection</Link></li>
                  </ul>
                </div>
              </div>
            )}
